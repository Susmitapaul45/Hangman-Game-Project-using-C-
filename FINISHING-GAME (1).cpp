...
a:
    ...
    string wordset3[]=
    {
        ...
        "confectioner","grandmother","nigeria"
    }; ///3rd level
    string word;
    int x;
...
c:
            ...
            if(level==1)
            {
                //setbkcolor(RED);
                //z=7-wrong;
                outtextxy(40,10,"-> Easy level running...");
            ...
            cout<<"1,step: "<<step <<" level: "<<L[step]<<" total_point: "<<C[step]<<" worng: "<<error[step]<<" Confidential "<<Confidential[step]<<"Wordth:"<<Word_th[step]<<endl;
            ...
            if(word==confidential)
            {
                ...
                {
                    total_point+=(5-wrong)*2;
                }
                else if(level==3)
                {
                    total_point+=(3-wrong)*3;
                }
